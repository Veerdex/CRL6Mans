// Pure presentational bracket rendering — no supabaseAdmin/server imports, so
// it's legal to render both from the live async fetch wrappers in
...
export function SEBracketDisplay({ matches: matchesRaw, teams }: { matches: DBMatch[]; teams: Record<string, Team> }) {
...
export function DEBracketDisplay({ matches: matchesRaw, teams }: { matches: DBMatch[]; teams: Record<string, Team> }) {
...
export function DEQualifierBracketDisplay({ matches: matchesRaw, teams }: { matches: DBMatch[]; teams: Record<string, Team> }) {
